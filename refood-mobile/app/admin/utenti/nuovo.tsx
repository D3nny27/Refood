...
import { Text, Appbar, TextInput, Button, ActivityIndicator, HelperText, Divider, Chip, List, Avatar, RadioButton, TouchableRipple } from 'react-native-paper';
    ...
    switch (field) {
      ...
      case 'password':
        if (!form.password) {
          ...
          setErrors(prev => ({ ...prev, password: 'La password deve contenere almeno 6 caratteri' }));
          return false;
        }
        return true;
              ...
              >
                <View style={styles.radioContent}>
                  ...
                  <View style={styles.radioTextContainer}>
                    ...
                    <Text style={styles.radioDescription}>Può gestire i lotti e le prenotazioni</Text>
                  </View>
              ...
              >
                <View style={styles.radioContent}>
                  ...
                  <View style={styles.radioTextContainer}>
                    ...
                    <Text style={styles.radioDescription}>Può gestire centri, operatori e impostazioni</Text>
                  </View>
