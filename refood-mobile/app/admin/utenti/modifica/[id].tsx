...
const ModificaUtenteScreen = () => {
  ...
  useEffect(() => {
    const fetchUtente = async () => {
      try {
        ...
        const utente = await utentiService.getUtenteById(utenteId);
  ...
  const updateUtente = async () => {
    ...
    try {
      // Prepara i dati da inviare - assicuriamoci che i campi null diventino undefined
      const utenteData: Partial<Utente> = {
        nome,
        indirizzo,
