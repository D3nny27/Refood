...
import { Text, Appbar, Card, Divider, FAB, Button, ActivityIndicator, Searchbar, Chip, Avatar, List, Checkbox, SegmentedButtons } from 'react-native-paper';
