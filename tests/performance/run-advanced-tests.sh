...
run_all_tests() {
    ...
    k6 run tests/performance/advanced-load-test.js --out json=test_results/performance_complete_$(date +%Y%m%d_%H%M%S).json
...
generate_report() {
    ...
    k6 run --no-thresholds --no-summary tests/performance/advanced-load-test.js -o "output=test_results/summary.html"
...
main() {
    ...
    case $choice in
        1)
            ...
            ;;
        2)
            run_scenario "tests/performance/advanced-load-test.js" "realistic_journey"
            ;;
        3)
            run_scenario "tests/performance/advanced-load-test.js" "endurance"
            ;;
        4)
            run_scenario "tests/performance/advanced-load-test.js" "peak_load"
            ;;
        5)
            run_scenario "tests/performance/advanced-load-test.js" "search_stress"
            ;;
        6)
            run_scenario "tests/performance/advanced-load-test.js" "mixed_roles"
            ;;
        7)
            generate_report
            ;;
