-- Migrazione per rimuovere il campo tipo_utente_origine_id dalla tabella Lotti

-- Crea una tabella temporanea senza il campo tipo_utente_origine_id
...
-- Copia i dati dalla tabella originale alla temporanea (escludendo tipo_utente_origine_id)
